...
dataset = np.loadtxt("trainingDump/discreteLossData.csv", delimiter=",")
...
learningRateOptions = [0.01]
units1Options = [20]
units2Options = [20]
units3Options = [0]
batchSizeOptions = [40]
epochsOptions = [2000]
optimizerOptions = ['adam']#['adam', 'rmsprop','sgd','adadelta']
dropout1Options = [0]
dropout2Options = [0]
dropout3Options = [0]
patienceOptions = [20]
...
# Save final model as JSON.
    ...
    with open("decisionMakers/decisionMaker11/lossPrediction.json", "w") as json_file:
        json_file.write(model_json)
    # Serialize weights to HDF5.
    model.save_weights("decisionMakers/decisionMaker11/lossPrediction.h5")
